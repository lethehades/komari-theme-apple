  ...
  return (
    <div className="fade-in my-4">
      ...
      {enableGroupedBar && !mergeGroupsWithStats && (
        <div className="apple-group-bar flex purcarte-blur theme-card-style overflow-auto whitespace-nowrap overflow-x-auto items-center min-w-[300px] text-primary space-x-4 px-4 my-4">
